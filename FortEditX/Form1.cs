...
namespace FortEditX
{
    public partial class Form1 : Form
    {
        ...
        private string[] settingsKeys = {
            "bMotionBlur",
            "bShowGrass",
            "bUseGPUCrashDebugging",
            "bStopRenderingInBackground",
            "bLatencyTweak1",
            "LatencyTweak2",
        ...
        public Form1()
        {
            ...
            {
                textBoxes[i] = new TextBox { Top = 10 + (i * 30), Left = 10, Width = 200 };
                Controls.Add(textBoxes[i]);
            }

            applyBtn = new Button { Text = "Apply", Top = 280, Left = 10 };
        ...
        private void ApplyChanges(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Changes accepted and file read-only again.",
                  "Awesome! successfully saved",
        ...
        {
            MessageBox.Show("To use this tool, simply click the 'Apply' button. The program has already automatically adjusted all the settings as shown in the video, so you don't need to make any changes yourself.",
                            "How to Use",
                            MessageBoxButtons.OK,
                            MessageBoxIcon.Information);
        }
